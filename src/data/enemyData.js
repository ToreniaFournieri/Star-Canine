...
export const EN = [
  ...
  [7, "重装巡洋艦", 80, 80, R.N, [10, 20, 20], [[SK.GATE, 5]]],
  [8, "シールド・ゲート", 100, 20, R.E, [15, 15, 10], [[SK.GATE, 20]]],
  [9, "オーバーロード・エンフォーサー", 120, 30, R.E, [25, 25, 20], [[SK.OVR, 1.5]]],
  [10, "セレスティアル・リーパー", 140, 60, R.B, [40, 30, 35], [[SK.CL, 25]]],
];
