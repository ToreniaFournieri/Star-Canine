...
const EN = [
  ...
  [xx, "シールド・ゲート", 100, 20, R.E, [10, 10, 5], [[SK.GATE, 20]]],
  [xx, "オーバーロード・エンフォーサー", 120, 30, R.E, [20, 20, 25], [[SK.OVR, 2.0]]],
  
  // ACT III Normal Enemies (ID 40–59)

  // Patrol / Surveillance
  [40, "センチネル級 監視艇", 95, 15, R.N, [25, 20, 15], [[SK.GATE, 12], [SK.CL, 8]]],
  [41, "スキャナー級 巡察艦", 100, 10, R.N, [30, 20, 15], [[SK.REGEN, 12], [SK.DOR, 0]]],

  // Light Combat
  [42, "ストライカー級 軽攻撃艇", 90, 5, R.N, [30, 25, 20], [[SK.OVR, 1.5], [SK.DEG, 10]]],
  [43, "ランサー級 突撃艇", 105, 10, R.N, [25, 30, 25], [[SK.OVR, 1.6], [SK.GATE, 12]]],

  // Midline Combat
  [44, "ヴァンガード級 護衛艦", 120, 25, R.N, [30, 25, 20], [[SK.GATE, 16], [SK.CL, 10]]],
  [45, "ドミネーター級 中型戦闘艦", 130, 15, R.N, [30, 30, 25], [[SK.OVR, 1.7], [SK.REGEN, 12]]],

  // Heavy Normal Combat
  [46, "ウォーデン級 防衛艦", 145, 30, R.N, [25, 30, 25], [[SK.GATE, 18], [SK.REGEN, 14]]],
  [47, "レイダー級 襲撃艦", 135, 15, R.N, [35, 25, 25], [[SK.OVR, 1.8], [SK.CL, 12]]],

  // Industrial / Support Combat
  [48, "オービター級 軌道作業艇", 110, 20, R.N, [25, 25, 20], [[SK.GATE, 14], [SK.DOR, 0]]],

  // Logistics / Civilian-Class (Still Dangerous)
  [49, "プロビジョン級 補給船", 105, 15, R.N, [20, 25, 15], [[SK.DOR, 0], [SK.REGEN, 14]]],
  [50, "カーゴ級 輸送艇", 110, 10, R.N, [20, 30, 15], [[SK.DOR, 0], [SK.GATE, 14]]],
  [51, "マーケット級 民間輸送船", 115, 15, R.N, [25, 20, 15], [[SK.DOR, 0], [SK.REGEN, 16]]],
  [52, "フレイター級 長距離貨物船", 120, 15, R.N, [20, 30, 15], [[SK.DOR, 0], [SK.DEG, 12]]],

  // Attrition / Harassment
  [53, "ハラス級 妨害艇", 105, 15, R.N, [25, 30, 15], [[SK.DEG, 14], [SK.CL, 10]]],
  [54, "ファントム級 電子戦艇", 95, 10, R.N, [25, 25, 15], [[SK.OVR, 1.6], [SK.DOR, 0]]],

  // Defensive Wall
  [55, "シールド・ノード", 130, 35, R.N, [20, 25, 15], [[SK.GATE, 20], [SK.DOR, 0]]],

  // Elite-like Normals (Hard Encounters)
  [56, "アーク・ガーディアン", 150, 35, R.N, [30, 30, 20], [[SK.GATE, 20], [SK.REGEN, 14]]],
  [57, "ナイト・クルーザー", 155, 25, R.N, [35, 25, 30], [[SK.OVR, 1.9], [SK.CL, 12]]],
  [58, "ブラック・ピケット", 145, 20, R.N, [30, 30, 20], [[SK.DEG, 16], [SK.REGEN, 12]]],

  // Fortress Elite — Imperial Wall
  [70, "アストラ・バスティオン級 要塞巡洋艦", 210, 55, R.E, [35, 35, 25], [[SK.GATE, 24], [SK.REGEN, 16]]],
  // Execution Elite — Scaling Kill Threat
  [71, "レッド・エクスキューター級 強襲戦艦", 195, 35, R.E, [45, 40, 30], [[SK.OVR, 2.2], [SK.CL, 16]]],
  // Doomed Titan — Overbuilt, Self-Decaying Monster
  [72, "モルティス・オメガ級 崩壊殲滅艦", 240, 50, R.E,[45, 35, 30], [[SK.DEG, 22], [SK.REGEN, 12]]],
  ...
  [86, "若き皇子", 160, 45, R.B, [35, 15, 25], [[SK.OVR, 2.2]]],
  [87, "ブラック・アーキビスト", 170, 75, R.B, [20, 25, 15], [[SK.CL, 12], [SK.GATE, 10]]],
  [88, "チェイン・アドミラル", 185, 85, R.B, [30, 20, 15], [[SK.GATE, 16], [SK.REGEN, 6]]],
];
```
