# STAR CANINE SPECIFICATION v0.6.13
...
- Scaling Rule: Multiply Enemy `hull`, `shield`, `armor`, and all attack values by the Act Factor: ACT I: x1.0 | ACT II: x2.0 | ACT III: x3.0
...
1.  **Resupply:** `ammo +5`
2.  **Salvage:** Choose 1 of 3 items matching the Enemy's `rank` and`rarity` (Normal:1, Elite:2, Boss:3).
