...
const EQ = [
  ...
  [1, "🚀 🚀 🔺 ギャンビット", 50, T.L, 2, 1, [T.L, 1.2], null],
  ...
  [1, "✈️🔺 スクアドラル", 12, T.M, 2, 0, [AB.AM, 10], null],
  ...
  [1, "🛡️ ⤴️ バリアー", 10, T.S, 2, 0, [AB.GR, 3], null],

  // === HULL ===
  [1, "🔧 💥ダメージコントロール", 30, T.H, 1, 1, null, null],
  [1, "🔧🔧 自動修理装置", 15, T.H, 2, 0, null, null],

  // === MODULE ===
  [1, "🟫🔺 ダブルシールド", 0, T.X, 1, 0, [T.S, 3.0], null],
...
const EN = [
  ...
  [6, "シールド・ゲート", 55, 20, R.E, [10, 10, 5], [[SK.GATE, 20]]],
