...
const EN = [
  ...
  [50, "シールド・ゲート", 100, 20, R.E, [10, 10, 5], [[SK.GATE, 20]]],
  [51, "オーバーロード・エンフォーサー", 120, 30, R.E, [20, 20, 25], [[SK.OVR, 2.0]]],
  
  [80, "ソーラー・ベア前衛艦", 140, 30, R.B, [35, 10, 15], [[SK.OVR, 1.6]]],
  [81, "ハル・リーヴァー", 160, 135, R.B, [15, 15, 20], [[SK.DEG, 20]]],
  [82, "トール・キング", 150, 55, R.B, [10, 10, 10], [[SK.GATE, 8], [SK.DOR, 0]]],
  [83, "ベルト・ウォーロード", 150, 35, R.B, [30, 20, 20], [[SK.OVR, 1.5]]],
  [84, "エコーズ", 170, 45, R.B, [15, 25, 15], [[SK.REGEN, 5], [SK.DOR, 0]]],
  ...
  [88, "チェイン・アドミラル", 185, 85, R.B, [10, 20, 15], [[SK.GATE, 16], [SK.REGEN, 6]]],
];
```
